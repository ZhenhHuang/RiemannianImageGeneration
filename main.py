...
parser.add_argument('--verbose_freq', type=int, default=200)
...
parser.add_argument('--hidden_dims', type=int, nargs='+', default=[64, 128, 256], help='dimension of hidden layers')
